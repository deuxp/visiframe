  ...
  return (
    <div className={style.box}>
      ...
      <p>
        ...
        videos, images, and other content available through the Application. By
        using the Application, you agree to be bound by these terms. If you do
        not agree to these terms, you may not use the Application. <br /> <br />{" "}
        1. License <br />
        ...
        Application or its content for any commercial purpose without our prior
        written consent. <br />
        <br /> 1. Content <br />
        ...
        consent. <br />
        <br /> 1. Use of the Application <br />
        ...
        <br />- For the purpose of exploiting, harming, or attempting to exploit
        ...
        or any other similar solicitation <br />
        ...
        anyone's use or enjoyment of the Application, or which, as determined by
        us, may harm Utopics or users of the Application or expose them to
        liability <br />
        <br /> 1. Termination <br />
        <br /> We may terminate or suspend your access to the Application
        immediately, without prior notice or liability, for any reason
        whatsoever, including without limitation if you breach these terms. Upon
        termination, your right to use the Application will immediately cease.
        <br />
        <br />
        1. Disclaimer of Warranties <br />
        <br />
        ...
        materials, or products included on the Application. You expressly agree
        that your use of the Application is at your sole risk. <br />
        <br /> 1. Limitation of Liability <br />
        <br />
        ...
        <br /> <br /> - Any modification, suspension, or discontinuation of the
        Application; <br />
        <br />- Any interruption, delay, or other failure in the operation or
        availability of the Application; <br /> <br /> - Any unauthorized access
        to or alteration of your transmissions or data; <br /> <br />- Any
        third-party content, websites, or services that may be linked to or from
        the Application; or <br /> <br />- Any other matter relating to the
        Application. <br />
        ...
        you. <br />
        <br />
        You acknowledge and agree that we have made the Application available to
        you in reliance upon the limitations of liability and disclaimers of
        warranty and damages set forth herein, and that the same form an
        essential basis of the agreement between you and us. You agree that the
        limitations and exclusions of liability and disclaimers specified in
        this Agreement will survive and apply even if found to have failed their
        essential purpose.
      </p>
    </div>
  );
